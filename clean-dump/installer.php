...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'yappie_clean_dump_142ba4671909bfbc6800_20230119085910_archive.zip';
        const ARCHIVE_SIZE       = '30386494';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '142ba46-19085910';
        const SECONDARY_PACKAGE_HASH = 'f376712-19085910';
        const VERSION            = '1.5.1';
